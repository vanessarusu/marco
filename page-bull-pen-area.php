...
<div class="custom-container">
	<div class="col span_65 div-padding no-padding-top quote-gform">
		<h2>Bull Pen Area</h2>
		<?php echo do_shortcode('[gravityform id=5 title=false description=false ajax=true tabindex=49 update='. $_GET['qid'] .' field_values="quote_id='. $_GET['qid'] .'"]');?>
		<?php //gravity_form('Bull Pen Area', false, false, false, '', false); ?>
