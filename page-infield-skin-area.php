...
<div class="custom-container">
	...
	<div class="col span_35 div-padding no-padding-top">
		<img style="display:none;" src="<?php echo get_stylesheet_directory_uri() . '/dist/images/diagrams/infield_skin_area/infield_skin_area_diagram.gif' ; ?>" class="field-diagram" />
